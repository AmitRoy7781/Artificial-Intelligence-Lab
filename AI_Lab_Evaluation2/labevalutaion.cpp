...
int minimax(char board[100][100], bool isMax,int alpha,int beta)
{
        ...
        for (int i = 0; i<n; i++)
        {
            for (int j = 0; j<n; j++)
            {
                ...
                if (board[i][j]=='_')
                {
                    ...
                    best = max( best,minimax(board, !isMax,alpha,beta));
        ...
        for (int i = 0; i<n; i++)
        {
            for (int j = 0; j<n; j++)
            {
                ...
                if (board[i][j]=='_')
                {
                    ...
                    best = min(best,minimax(board, !isMax,alpha,beta));
                    beta = min(beta,best);
    ...
    for (int i = 0; i<n; i++)
    {
        for (int j = 0; j<n; j++)
        {
            if (board[i][j]=='_')
            {
                ...
                int val = minimax(board, false,-1000,1000);
                board[i][j] = '_';
